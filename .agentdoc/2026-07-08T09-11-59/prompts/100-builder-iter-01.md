...
- Append ONE row to the Iteration Log table (iter 01, task, result,
  gates, commit sha, one-line note). Never edit existing rows or other tasks.

## 7. Write your session record

Create `.agentdoc/2026-07-08T09-11-59/sessions/iter-01.md` following
