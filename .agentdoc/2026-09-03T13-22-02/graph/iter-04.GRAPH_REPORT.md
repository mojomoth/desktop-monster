...
## Corpus Check
- 104 files · ~128,589 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 879 nodes · 1885 edges · 49 communities (44 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc2c26e1`
...
4. `PgStore` - 16 edges
5. `MemoryStore` - 16 edges
6. `monsterMaxHp()` - 15 edges
7. `parseSave()` - 15 edges
8. `COLORS` - 15 edges
9. `monsterForIndex()` - 14 edges
10. `mulberry32()` - 14 edges
...
Cohesion: 0.06
Nodes (35): CollectionAction, MenuBridge, MenuDocument, MenuElement, mountMenu(), PANELS, Pending, battleEnabled() (+27 more)

### Community 2 - "Community 2"
Cohesion: 0.16
Nodes (23): clamp01(), createDropPool(), createParticlePool(), drawParticles(), DropAnim, dropPosition(), easeInQuad(), easeOutQuad() (+15 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (77): [ ] T57 — Party selection: PARTY_SIZE, activeCompanions(cs, enemyType), autoParty, pvpParty, partyOrder, setPvpParty action, [ ] T58 — Battle simulation (battle.ts) + resolvePvp v3 with STEAL_CHANCE in collection.ts, [ ] T59 — Engine: type-adjusted volley, companionAttack.effectiveness, pvpResult.replay passthrough, [ ] T60 — Server POST /v1/pvp v3: match + party validation, core resolvePvp, steal + theft record, blows on the wire, [ ] T61 — Server GET /v1/thefts + POST /v1/reclaim (410 expired, 409 gone) + thefts in the snapshot response, [~] T62 — Party group sprites: party.ts (partySlots, drawParty, drawTypeBadge, TYPE_COLORS), boss scale by species size, BOSS_HP_BAR_Y 78, [ ] T64 — HUD/effects for the battle scene: floatColor(effectiveness) in hud.ts, hitColorOf(speciesId) in effects.ts, [ ] T65 — Field v3 layout: window 480×300, canvas 240×150, SPRITE_SCALE 1, size-scaled monsters, party group + type badge + effectiveness floats (+69 more)
...
Cohesion: 0.08
Nodes (30): Identity, createNetClient(), NetClient, NetSession, SnapshotSource, toSnapshot(), PendingMatch, main() (+22 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (78): bigField(), format(), ratio(), suffix(), activeCompanions(), applyCollection(), CollectionEvent, CollectionResult (+70 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (12): body(), join(), read(), BuildConfig, pkg, read(), readme, read() (+4 more)
...
Cohesion: 0.21
Nodes (11): IpcOptions, registerIpcHandlers(), createNetSession(), readSaveFile(), saveFilePath(), writeSaveFile(), InputMode, IpcChannel (+3 more)
...
Cohesion: 0.19
Nodes (10): companionSlotOf(), Game, monsterCentre(), monsterScale(), SaveScheduler, SaveSchedulerOptions, speciesKey(), speciesSpritesFor() (+2 more)
...
## Knowledge Gaps
- **304 isolated node(s):** `name`, `productName`, `version`, `description`, `author` (+299 more)
...
- **Why does `join()` connect `Community 28` to `Community 32`, `Community 33`, `Community 39`, `Community 47`, `Community 31`?**
