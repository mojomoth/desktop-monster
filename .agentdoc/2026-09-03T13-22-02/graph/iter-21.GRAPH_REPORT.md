...
## Corpus Check
- 109 files · ~146,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 950 nodes · 2185 edges · 56 communities (51 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36881ced`
...
Cohesion: 0.33
Nodes (10): damageForLevel(), monsterMaxHp(), xpReward(), xpToNext(), isBoss(), monsterForIndex(), SPECIES_DISPLAY_NAMES, SPECIES_SIZE (+2 more)
...
Cohesion: 0.17
Nodes (16): bigField(), format(), ratio(), suffix(), resolvePvp(), companionsField(), intField(), isInt() (+8 more)
...
Cohesion: 0.20
Nodes (12): createEngine(), mulberry32(), SaveFileV1, SaveFileV2, serializeSave(), upgradeSave(), calmRng(), makeSave() (+4 more)
