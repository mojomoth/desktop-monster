...
## Corpus Check
- 107 files · ~132,699 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 905 nodes · 1997 edges · 52 communities (47 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76719b5b`
...
Cohesion: 0.10
Nodes (27): createEngine(), InputSource, DragEventName, DragEventTarget, DragListener, DragPointerEvent, setupWindowDrag(), WindowDragHandle (+19 more)
...
Cohesion: 0.13
Nodes (26): GameCanvas, HP_BAR, Banner, drawBanner(), drawCounters(), drawFloats(), drawHpBar(), drawLevelHud() (+18 more)
...
Cohesion: 0.09
Nodes (29): createNetClient(), NetClient, NetSession, toSnapshot(), main(), probeName(), ProbeResult, runProbe() (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.25
Nodes (12): companionsField(), intField(), isInt(), itemsField(), parseSave(), pvpPartyField(), SaveFileV1, SaveFileV2 (+4 more)
...
Cohesion: 0.11
Nodes (34): SPECIES_IDS, clamp01(), createDropPool(), createParticlePool(), drawParticles(), DropAnim, dropPosition(), easeInQuad() (+26 more)
...
Cohesion: 0.08
Nodes (39): bigField(), format(), ratio(), suffix(), createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState (+31 more)

### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (14): mulberry32(), SnapshotSource, AppDeps, isInt(), matches, parseSnapshot(), PendingMatch, record() (+6 more)
...
Cohesion: 0.21
Nodes (9): IpcOptions, registerIpcHandlers(), createNetSession(), InputMode, IPC, IpcChannel, LeaderboardQueryPayload, MoveWindowPayload (+1 more)
...
Cohesion: 0.20
Nodes (11): Battle, Blow, Fighter, line(), simulateBattle(), companionPower(), partyOrder(), typeOf() (+3 more)
...
Cohesion: 0.18
Nodes (14): damageForLevel(), monsterMaxHp(), xpReward(), xpToNext(), isBoss(), monsterForIndex(), SPECIES_SIZE, SPECIES_TYPE (+6 more)
...
## Knowledge Gaps
- **303 isolated node(s):** `name`, `productName`, `version`, `description`, `author` (+298 more)
...
- **Why does `join()` connect `Community 28` to `Community 33`, `Community 50`, `Community 51`, `Community 47`?**
