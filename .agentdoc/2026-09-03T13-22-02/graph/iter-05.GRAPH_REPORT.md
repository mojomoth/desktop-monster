...
## Corpus Check
- 105 files · ~129,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 885 nodes · 1925 edges · 42 communities (37 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be00a3c3`
...
Cohesion: 0.08
Nodes (61): sizeOf(), drawFeverAura(), drawBoss(), companionSlot(), drawCompanion(), drawText(), DrawTextOptions, fontSprite (+53 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (34): MenuBridge, MenuDocument, MenuElement, mountMenu(), PANELS, Pending, battleEnabled(), canRebirth() (+26 more)
...
Cohesion: 0.03
Nodes (77): [~] T57 — Party selection: PARTY_SIZE, activeCompanions(cs, enemyType), autoParty, pvpParty, partyOrder, setPvpParty action, [ ] T58 — Battle simulation (battle.ts) + resolvePvp v3 with STEAL_CHANCE in collection.ts, [ ] T59 — Engine: type-adjusted volley, companionAttack.effectiveness, pvpResult.replay passthrough, [ ] T60 — Server POST /v1/pvp v3: match + party validation, core resolvePvp, steal + theft record, blows on the wire, [ ] T61 — Server GET /v1/thefts + POST /v1/reclaim (410 expired, 409 gone) + thefts in the snapshot response, [ ] T64 — HUD/effects for the battle scene: floatColor(effectiveness) in hud.ts, hitColorOf(speciesId) in effects.ts, [ ] T65 — Field v3 layout: window 480×300, canvas 240×150, SPRITE_SCALE 1, size-scaled monsters, party group + type badge + effectiveness floats, [ ] T66 — Battle scene: Game.playReplay, mirrored opponent group, blow pacing, KO scatter, banners, field hidden + presentation suppressed (+69 more)
...
Cohesion: 0.11
Nodes (24): createNetClient(), NetClient, NetSession, toSnapshot(), main(), probeName(), ProbeResult, runProbe() (+16 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (77): bigField(), format(), ratio(), suffix(), activeCompanions(), applyCollection(), CollectionAction, CollectionEvent (+69 more)
...
Cohesion: 0.05
Nodes (72): createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState, heroInput(), MONSTER_DURATION, MONSTER_NEXT, MonsterAnim (+64 more)
...
Cohesion: 0.16
Nodes (9): defaultName(), Identity, identityFilePath(), isValidName(), readIdentity(), writeIdentity(), createNetSession(), PVP (+1 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (14): SnapshotSource, AppDeps, isInt(), matches, parseSnapshot(), partyOf(), PendingMatch, record() (+6 more)
...
Cohesion: 0.13
Nodes (10): PgStore, toRow(), compareScore(), MemoryRow, PlayerRow, Scored, ScoreKey, Snapshot (+2 more)
...
Cohesion: 0.11
Nodes (20): createApp(), setup(), ApiHandler, ApiRequest, ApiResponse, clientIp(), createRequestListener(), HttpReq (+12 more)
...
- **Why does `MemoryStore` connect `Community 43` to `Community 38`, `Community 33`, `Community 46`?**
