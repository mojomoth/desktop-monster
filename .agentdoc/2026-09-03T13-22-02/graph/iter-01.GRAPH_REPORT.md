...
## Corpus Check
- 104 files · ~128,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 877 nodes · 1877 edges · 44 communities (39 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9d18226`
...
Cohesion: 0.12
Nodes (18): registerIpcHandlers(), createNetClient(), createNetSession(), NetClient, NetSession, SnapshotSource, toSnapshot(), PendingMatch (+10 more)
...
Cohesion: 0.22
Nodes (8): body(), join(), read(), read(), indexTs, read(), styleCss, windowTs
...
Cohesion: 0.12
Nodes (12): AppDeps, PgStore, toRow(), compareScore(), MemoryRow, PlayerRow, Scored, ScoreKey (+4 more)
...
Cohesion: 0.09
Nodes (22): createApp(), isInt(), matches, parseSnapshot(), partyOf(), record(), Call, setup() (+14 more)

### Community 48 - "Community 48"
Cohesion: 0.10
Nodes (20): body(), Call, comp(), player(), titan(), ApiError, BattleReplay, LeaderboardRow (+12 more)
...
- **Why does `join()` connect `Community 28` to `Community 32`, `Community 33`, `Community 39`, `Community 46`, `Community 31`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `MemoryStore` connect `Community 43` to `Community 48`, `Community 38`, `Community 46`?**
