...
## Corpus Check
- 107 files · ~136,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 925 nodes · 2070 edges · 60 communities (55 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3dab54fa`
...
Cohesion: 0.15
Nodes (35): sizeOf(), drawFeverAura(), drawBoss(), companionSlot(), drawCompanion(), drawText(), DrawTextOptions, fontSprite (+27 more)
...
Cohesion: 0.10
Nodes (19): line(), simulateBattle(), applyCollection(), autoParty(), CollectionEvent, CollectionResult, companionPower(), minted() (+11 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (77): [~] T61 — Server GET /v1/thefts + POST /v1/reclaim (410 expired, 409 gone) + thefts in the snapshot response, [~] T65 — Field v3 layout: window 480×300, canvas 240×150, SPRITE_SCALE 1, size-scaled monsters, party group + type badge + effectiveness floats, [ ] T66 — Battle scene: Game.playReplay, mirrored opponent group, blow pacing, KO scatter, banners, field hidden + presentation suppressed, [ ] T69 — Theft watcher (main): createTheftWatcher with injected timers, native Notification, reclaim → addCompanion via sendToAll, [ ] T71 — Menu binder v3: find opponent, party editor (auto/save), Battle! with match + party, replay forwarding, thefts inbox + reclaim, roster badges/PvP marks, [ ] T72 — Version 0.3.0, tray title, README v3, SPEC M15–M20 gaps, packaging test literal, [ ] T73 — Render deploy v3: desmon-server-v3 from branch v3, SERVER_URL baked, push HEAD:v3, deploy --wait, healthz + probe, AGENTS.md §Server, [ ] T74 — Deploy re-verify v3: healthz sha ancestor of v3 HEAD, build-filter paths untouched, redeploy if stale (+69 more)
...
Cohesion: 0.19
Nodes (9): matches, body(), Call, join(), LeaderboardResponse, RegisterResponse, SnapshotResponse, read() (+1 more)
...
Cohesion: 0.15
Nodes (8): NetClient, PvpRequest, Snapshot, FakeClient, MATCH, PVP, Recorded, THEFT

### Community 27 - "Community 27"
Cohesion: 0.16
Nodes (18): mulberry32(), companionsField(), intField(), isInt(), itemsField(), parseSave(), pvpPartyField(), SaveFile (+10 more)
...
Cohesion: 0.09
Nodes (36): activeCompanions(), xpToNext(), companionSlotOf(), Game, GameCanvas, HP_BAR, monsterCentre(), monsterScale() (+28 more)
...
Cohesion: 0.09
Nodes (12): AppDeps, PgStore, toRow(), compareScore(), MemoryRow, MemoryStore, PlayerRow, Scored (+4 more)

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (11): IpcOptions, registerIpcHandlers(), createNetSession(), InputMode, IPC, IpcChannel, LeaderboardQueryPayload, MoveWindowPayload (+3 more)
...
Cohesion: 0.21
Nodes (15): createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState, heroInput(), MONSTER_DURATION, MONSTER_NEXT, MonsterAnim (+7 more)

### Community 44 - "Community 44"
Cohesion: 0.19
Nodes (9): SnapshotSource, isInt(), parseSnapshot(), PendingMatch, record(), Companion, LeaderboardRow, PvpOpponent (+1 more)
...
Cohesion: 0.29
Nodes (9): defaultName(), Identity, identityFilePath(), isValidName(), readIdentity(), writeIdentity(), NetSession, ReclaimResponse (+1 more)
...
Cohesion: 0.16
Nodes (17): Battle, Blow, Fighter, isBoss(), monsterForIndex(), SPECIES_DISPLAY_NAMES, SPECIES_SIZE, SPECIES_TYPE (+9 more)
...
Cohesion: 0.21
Nodes (19): desmon, DesmonApi, Window, BattleReplay, IdentityPayload, LeaderboardResult, MatchResult, MonsterType (+11 more)
...
Cohesion: 0.29
Nodes (9): body(), Call, comp(), fight(), player(), preview(), titan(), ApiError (+1 more)

### Community 56 - "Community 56"
Cohesion: 0.40
Nodes (4): mainIndexTs, mainIpcTs, preloadTs, read()
...
- **Why does `join()` connect `Community 19` to `Community 47`, `Community 56`, `Community 58`, `Community 59`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `MemoryStore` connect `Community 38` to `Community 19`, `Community 46`, `Community 55`?**
