...
## Corpus Check
- 107 files · ~139,189 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 927 nodes · 2094 edges · 55 communities (49 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19cff0ff`
...
Cohesion: 0.17
Nodes (30): sizeOf(), drawFeverAura(), drawBoss(), drawCompanion(), drawText(), DrawTextOptions, fontSprite, glyphIndex() (+22 more)
...
Cohesion: 0.18
Nodes (14): companionPower(), monsterMaxHp(), isBoss(), monsterForIndex(), SPECIES_DISPLAY_NAMES, SPECIES_SIZE, SPECIES_TYPE, SpeciesId (+6 more)
...
Cohesion: 0.09
Nodes (36): Game, GameCanvas, HP_BAR, monsterCentre(), monsterScale(), partySlotOf(), SaveScheduler, SaveSchedulerOptions (+28 more)

### Community 26 - "Community 26"
Cohesion: 0.11
Nodes (17): createNetClient(), NetClient, NetSession, toSnapshot(), main(), probeName(), ProbeResult, runProbe() (+9 more)

### Community 27 - "Community 27"
Cohesion: 0.21
Nodes (15): companionsField(), DEFAULT_SAVE, intField(), isInt(), itemsField(), parseSave(), pvpPartyField(), SaveFile (+7 more)
...
Cohesion: 0.14
Nodes (15): mulberry32(), Call, comp(), setup(), stolen(), BattleReplay, LeaderboardRow, MatchResponse (+7 more)
...
Cohesion: 0.23
Nodes (8): SnapshotSource, AppDeps, isInt(), parseSnapshot(), PendingMatch, record(), Store, Companion

### Community 44 - "Community 44"
Cohesion: 0.25
Nodes (10): matches, body(), Call, comp(), fight(), player(), preview(), titan() (+2 more)
...
- **Why does `join()` connect `Community 31` to `Community 32`, `Community 47`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `MemoryStore` connect `Community 45` to `Community 32`, `Community 38`, `Community 43`, `Community 44`, `Community 28`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `InputModePayload` connect `Community 5` to `Community 19`, `Community 51`, `Community 4`, `Community 39`?**
