...
## Corpus Check
- 107 files · ~134,795 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 921 nodes · 2045 edges · 57 communities (51 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1dc7e10e`
...
Cohesion: 0.09
Nodes (24): Battle, Blow, Fighter, line(), simulateBattle(), activeCompanions(), applyCollection(), autoParty() (+16 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (77): [~] T60 — Server POST /v1/pvp v3: match + party validation, core resolvePvp, steal + theft record, blows on the wire, [ ] T61 — Server GET /v1/thefts + POST /v1/reclaim (410 expired, 409 gone) + thefts in the snapshot response, [ ] T65 — Field v3 layout: window 480×300, canvas 240×150, SPRITE_SCALE 1, size-scaled monsters, party group + type badge + effectiveness floats, [ ] T66 — Battle scene: Game.playReplay, mirrored opponent group, blow pacing, KO scatter, banners, field hidden + presentation suppressed, [ ] T68 — IPC v3: PVP_MATCH/THEFTS/RECLAIM channels, PVP payload, narrowAction setPvpParty + replay, preload, global.d.ts, sendToAll, [ ] T69 — Theft watcher (main): createTheftWatcher with injected timers, native Notification, reclaim → addCompanion via sendToAll, [ ] T71 — Menu binder v3: find opponent, party editor (auto/save), Battle! with match + party, replay forwarding, thefts inbox + reclaim, roster badges/PvP marks, [ ] T72 — Version 0.3.0, tray title, README v3, SPEC M15–M20 gaps, packaging test literal (+69 more)
...
Cohesion: 0.09
Nodes (38): createHeroAnim(), createMonsterAnim(), createDropPool(), createParticlePool(), createGame(), Game, GameCanvas, HP_BAR (+30 more)
...
Cohesion: 0.09
Nodes (29): Identity, registerIpcHandlers(), createNetClient(), createNetSession(), NetClient, NetSession, toSnapshot(), main() (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.24
Nodes (12): bigField(), format(), ratio(), suffix(), resolvePvp(), companionsField(), intField(), isInt() (+4 more)
...
Cohesion: 0.16
Nodes (23): SPECIES_IDS, clamp01(), drawParticles(), DropAnim, dropPosition(), easeInQuad(), easeOutQuad(), lerp() (+15 more)
...
Cohesion: 0.21
Nodes (8): SnapshotSource, isInt(), parseSnapshot(), PendingMatch, record(), Companion, LeaderboardRow, PvpOpponent
...
Cohesion: 0.16
Nodes (17): damageForLevel(), monsterMaxHp(), xpReward(), xpToNext(), isBoss(), monsterForIndex(), SPECIES_DISPLAY_NAMES, SPECIES_SIZE (+9 more)

### Community 46 - "Community 46"
Cohesion: 0.11
Nodes (18): createApp(), matches, Call, setup(), ApiHandler, ApiRequest, ApiResponse, clientIp() (+10 more)
...
Cohesion: 0.18
Nodes (18): COIN_ITEM, coinsForIndex(), pickWeightedTrinket(), rollLoot(), TOTAL_WEIGHT, TRINKET_TABLE, WeightedTrinket, mulberry32() (+10 more)
...
- **Why does `join()` connect `Community 28` to `Community 39`, `Community 46`, `Community 47`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `MemoryStore` connect `Community 43` to `Community 38`, `Community 46`, `Community 55`?**
