...
## Corpus Check
- 76 files · ~74,632 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 582 nodes · 1102 edges · 31 communities (28 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `89f78c7b`
...
Cohesion: 0.10
Nodes (26): InputSource, DragEventName, DragEventTarget, DragListener, DragPointerEvent, setupWindowDrag(), WindowDragHandle, WindowDragOptions (+18 more)
...
- **Why does `InputSource` connect `Community 5` to `Community 1`, `Community 2`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
