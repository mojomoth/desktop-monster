...
## Corpus Check
- 82 files · ~79,802 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 633 nodes · 1225 edges · 38 communities (35 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32563cb8`
...
Cohesion: 0.07
Nodes (51): drawCounters(), drawText(), DrawTextOptions, fontSprite, glyphIndex(), HERO_PALETTE, heroAttack, heroIdle (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (53): bigField(), format(), ratio(), suffix(), clampHp(), Engine, initialState(), damageForLevel() (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.16
Nodes (22): SPECIES_IDS, clamp01(), drawParticles(), DropAnim, dropPosition(), easeInQuad(), easeOutQuad(), lerp() (+14 more)
...
Cohesion: 0.10
Nodes (29): defaultName(), Identity, identityFilePath(), isValidName(), readIdentity(), writeIdentity(), createNetClient(), createNetSession() (+21 more)
...
Cohesion: 0.08
Nodes (45): xpToNext(), createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState, heroInput(), MONSTER_DURATION, MONSTER_NEXT (+37 more)
