...
## Corpus Check
- 93 files · ~94,219 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 723 nodes · 1524 edges · 41 communities (37 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c58b7d3`
...
Cohesion: 0.05
Nodes (54): activeCompanions(), applyCollection(), CollectionAction, CollectionEvent, CollectionResult, companionPower(), minted(), reroster() (+46 more)
...
Cohesion: 0.07
Nodes (56): bigField(), format(), ratio(), suffix(), createEngine(), xpToNext(), createHeroAnim(), createMonsterAnim() (+48 more)
