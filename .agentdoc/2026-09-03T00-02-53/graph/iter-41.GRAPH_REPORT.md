...
## Corpus Check
- 99 files · ~100,123 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 762 nodes · 1645 edges · 50 communities (45 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5bad369f`
...
Cohesion: 0.06
Nodes (75): GameCanvas, HP_BAR, Banner, drawBanner(), drawCounters(), drawFloats(), drawHpBar(), drawLevelHud() (+67 more)
...
Cohesion: 0.07
Nodes (56): bigField(), format(), ratio(), suffix(), createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState (+48 more)
...
Cohesion: 0.16
Nodes (15): clampHp(), COLD_FEVER, createEngine(), Engine, initialState(), createFever(), Fever, feverActive() (+7 more)
...
Cohesion: 0.16
Nodes (9): activeCompanions(), applyCollection(), CollectionAction, CollectionEvent, CollectionResult, minted(), reroster(), Companion (+1 more)

### Community 32 - "Community 32"
Cohesion: 0.21
Nodes (12): companionPower(), damageForLevel(), monsterMaxHp(), xpReward(), xpToNext(), isBoss(), monsterForIndex(), SaveFileV2 (+4 more)

### Community 33 - "Community 33"
Cohesion: 0.19
Nodes (11): DragEventName, DragEventTarget, DragListener, DragPointerEvent, setupWindowDrag(), WindowDragHandle, WindowDragOptions, createSaveScheduler() (+3 more)
...
Cohesion: 0.22
Nodes (9): IpcOptions, readSaveFile(), saveFilePath(), writeSaveFile(), InputMode, IpcChannel, LeaderboardQueryPayload, MoveWindowPayload (+1 more)
...
Cohesion: 0.33
Nodes (5): IPC, mainIndexTs, mainIpcTs, preloadTs, read()
...
- **Why does `join()` connect `Community 46` to `Community 39`, `Community 44`, `Community 47`, `Community 48`, `Community 49`, `Community 28`?**
...
- **Why does `mulberry32()` connect `Community 46` to `Community 32`, `Community 0`, `Community 7`, `Community 42`, `Community 43`, `Community 45`, `Community 20`, `Community 27`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
