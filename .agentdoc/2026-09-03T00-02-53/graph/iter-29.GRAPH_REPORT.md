...
## Corpus Check
- 86 files · ~85,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 662 nodes · 1358 edges · 37 communities (33 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ad4bab9`
...
4. `COLORS` - 14 edges
5. `monsterMaxHp()` - 13 edges
6. `InputModePayload` - 13 edges
7. `AGENTS.md — Desktop Monster (DesMon)` - 13 edges
...
Cohesion: 0.20
Nodes (15): GlobalInputDeps, startGlobalInput(), desmon, DesmonApi, Window, IdentityPayload, LeaderboardResult, NetResult (+7 more)

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (14): intField(), itemsField(), parseSave(), DragEventName, DragEventTarget, DragListener, DragPointerEvent, setupWindowDrag() (+6 more)

### Community 41 - "Community 41"
Cohesion: 0.29
Nodes (6): readSaveFile(), saveFilePath(), writeSaveFile(), mainIndexTs, mainIpcTs, preloadTs
...
- **Why does `InputModePayload` connect `Community 38` to `Community 8`, `Community 4`, `Community 5`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `parseSave()` connect `Community 39` to `Community 2`, `Community 4`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `FakeHook` connect `Community 31` to `Community 38`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
