...
## Corpus Check
- 84 files · ~83,270 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 651 nodes · 1301 edges · 32 communities (29 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6707698`
...
Cohesion: 0.07
Nodes (57): bigField(), format(), ratio(), suffix(), activeCompanions(), applyCollection(), CollectionAction, CollectionEvent (+49 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (54): [ ] T28 — Engine: boss capture roll, apply(action), bestIndex, souls damage, [ ] T29 — Fever core: pure tracker on the engine clock, tick(dt), ×3 damage, [ ] T30 — Engine tick: companion volley every 1000 ms from the 3 strongest, [ ] T33 — Boss and companion art helpers: scale-3 boss with crown, raised HP bar, companion slots, [ ] T34 — Banner text parameter, VICTORY/DEFEAT/FEVER texts, hue-cycling fever aura, [ ] T36 — PvP resolution in core (shared with the server), [ ] T37 — Renderer wiring v2: engine tick in update(), A–Z floats, effects, boss/companion/fever presentation, fever blip, [ ] T39 — Server store + createApp: register, upload snapshot, leaderboard, rate limit, 404/500 (+46 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (37): FALLBACK, getCurrentInputMode(), GlobalInputController, GlobalInputDeps, NativeHook, startGlobalInput(), isSmoke, IpcOptions (+29 more)
