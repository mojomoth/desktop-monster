...
## Corpus Check
- 86 files · ~86,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 665 nodes · 1367 edges · 38 communities (35 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57cd6242`
...
Cohesion: 0.06
Nodes (69): bigField(), format(), ratio(), suffix(), activeCompanions(), applyCollection(), CollectionAction, CollectionEvent (+61 more)
...
Cohesion: 0.15
Nodes (14): getCurrentInputMode(), isSmoke, IpcOptions, registerIpcHandlers(), createNetClient(), createNetSession(), createOverlayWindow(), defaultPosition() (+6 more)
...
Cohesion: 0.40
Nodes (3): mainIndexTs, mainIpcTs, preloadTs
...
Cohesion: 0.07
Nodes (47): createEngine(), SPECIES_IDS, mulberry32(), clamp01(), createDropPool(), createParticlePool(), drawParticles(), DropAnim (+39 more)
...
## Knowledge Gaps
- **246 isolated node(s):** `name`, `productName`, `version`, `description`, `author` (+241 more)
...
- **Why does `parseSave()` connect `Community 2` to `Community 33`, `Community 4`?**
