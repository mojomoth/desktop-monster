...
## Corpus Check
- 102 files · ~106,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 823 nodes · 1792 edges · 44 communities (39 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `627dc6b2`
...
Cohesion: 0.05
Nodes (74): activeCompanions(), createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState, heroInput(), MONSTER_DURATION, MONSTER_NEXT (+66 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (54): [ ] T52 — Unsigned macOS packaging 0.2.0 + packaged SMOKE_OK, no pg or server build inside the .app, [ ] T53 — SPEC criteria sweep (F01–F58, Server / API, Deployment — literal), Tasks, [x] T01 — Scaffold frozen command contract, empty-but-green, [x] T02 — Transparent always-on-top overlay window + accessory lifecycle, [x] T03 — Shared IPC constants, preload bridge, persistence handlers, [x] T04 — Guarded global input hook (uiohook, production only), [x] T05 — Core types, progression formulas, monster catalog (+46 more)
...
Cohesion: 0.13
Nodes (18): createNetClient(), NetClient, NetSession, SnapshotSource, toSnapshot(), main(), probeName(), ProbeResult (+10 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (66): bigField(), format(), ratio(), suffix(), applyCollection(), CollectionEvent, CollectionResult, companionPower() (+58 more)
...
Cohesion: 0.10
Nodes (21): createApp(), isInt(), parseSnapshot(), record(), Call, setup(), ApiHandler, ApiRequest (+13 more)
...
## Knowledge Gaps
- **270 isolated node(s):** `name`, `productName`, `version`, `description`, `author` (+265 more)
...
- **Why does `join()` connect `Community 28` to `Community 32`, `Community 29`, `Community 46`, `Community 31`?**
