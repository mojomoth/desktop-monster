...
## Corpus Check
- 97 files · ~96,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 748 nodes · 1582 edges · 45 communities (40 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1329c5e`
...
Cohesion: 0.15
Nodes (22): createHeroAnim(), createMonsterAnim(), HeroAnim, HeroAnimState, heroInput(), MONSTER_DURATION, MONSTER_NEXT, MonsterAnim (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.14
Nodes (14): NetClient, NetSession, SnapshotSource, toSnapshot(), ApiError, Companion, LeaderboardResponse, NetError (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.17
Nodes (14): clampHp(), COLD_FEVER, createEngine(), Engine, initialState(), createFever(), Fever, feverActive() (+6 more)

### Community 28 - "Community 28"
Cohesion: 0.10
Nodes (20): readSaveFile(), saveFilePath(), writeSaveFile(), body(), join(), index, pgStore, pgTypes (+12 more)

### Community 29 - "Community 29"
Cohesion: 0.16
Nodes (12): resolvePvp(), createApp(), Call, setup(), ApiRequest, ApiResponse, body(), Call (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.16
Nodes (8): PgStore, toRow(), MemoryRow, PlayerRow, Scored, ScoreKey, Store, Snapshot
...
Cohesion: 0.20
Nodes (10): bigField(), format(), ratio(), suffix(), applyCollection(), CollectionAction, CollectionEvent, CollectionResult (+2 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (26): SPECIES_IDS, clamp01(), createDropPool(), createParticlePool(), drawParticles(), DropAnim, dropPosition(), easeInQuad() (+18 more)
...
Cohesion: 0.17
Nodes (10): ApiHandler, clientIp(), createRequestListener(), HttpReq, HttpRes, call(), HttpResShape, Init (+2 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (18): getCurrentInputMode(), isSmoke, IpcOptions, registerIpcHandlers(), showMenuWindow(), createNetClient(), createNetSession(), createOverlayWindow() (+10 more)
...
Cohesion: 0.24
Nodes (7): AppDeps, isInt(), parseSnapshot(), record(), compareScore(), LeaderboardRow, PvpOpponent
...
- **Why does `join()` connect `Community 28` to `Community 44`, `Community 29`?**
