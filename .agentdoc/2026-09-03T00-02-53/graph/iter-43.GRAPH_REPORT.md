...
## Corpus Check
- 102 files · ~103,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 803 nodes · 1744 edges · 44 communities (40 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc857f53`
...
Cohesion: 0.09
Nodes (21): CollectionAction, DEFAULT_SAVE, SaveFile, MenuBridge, MenuDocument, MenuElement, mountMenu(), PANELS (+13 more)
...
Cohesion: 0.11
Nodes (25): buildTrayMenuTemplate(), getActiveTray(), setupTray(), TrayController, TrayDeps, TrayLike, TrayMenuActions, TrayMenuItem (+17 more)

### Community 9 - "Community 9"
Cohesion: 0.20
Nodes (10): build, appId, asarUnpack, directories, files, npmRebuild, productName, win (+2 more)
...
Cohesion: 0.06
Nodes (61): activeCompanions(), createHeroAnim(), createMonsterAnim(), HeroAnim, heroInput(), MONSTER_DURATION, MONSTER_NEXT, MonsterAnim (+53 more)

### Community 26 - "Community 26"
Cohesion: 0.13
Nodes (15): NetClient, NetSession, SnapshotSource, Call, ApiError, Companion, LeaderboardResponse, NetError (+7 more)
...
Cohesion: 0.67
Nodes (3): nsis, deleteAppDataOnUninstall, oneClick

### Community 31 - "Community 31"
Cohesion: 0.20
Nodes (10): applyCollection(), CollectionEvent, CollectionResult, minted(), reroster(), SPECIES_DISPLAY_NAMES, SpeciesId, Companion (+2 more)

### Community 32 - "Community 32"
Cohesion: 0.20
Nodes (14): companionPower(), clampHp(), COLD_FEVER, initialState(), damageForLevel(), monsterMaxHp(), xpReward(), xpToNext() (+6 more)
...
Cohesion: 0.05
Nodes (36): resolvePvp(), AppDeps, createApp(), isInt(), parseSnapshot(), record(), ApiHandler, ApiRequest (+28 more)

### Community 39 - "Community 39"
Cohesion: 0.14
Nodes (14): getCurrentInputMode(), isSmoke, IpcOptions, registerIpcHandlers(), showMenuWindow(), createNetSession(), createOverlayWindow(), defaultPosition() (+6 more)
...
Cohesion: 0.20
Nodes (6): createEngine(), mulberry32(), SaveFileV2, setup(), stateWith(), stateFixture()

### Community 50 - "Community 50"
Cohesion: 0.15
Nodes (15): bigField(), format(), ratio(), suffix(), HeroAnimState, MonsterAnimState, createFallbackGate(), FallbackGate (+7 more)

## Knowledge Gaps
- **259 isolated node(s):** `name`, `productName`, `version`, `description`, `author` (+254 more)
...
- **Why does `join()` connect `Community 28` to `Community 26`, `Community 44`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `MemoryStore` connect `Community 38` to `Community 26`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `mulberry32()` connect `Community 46` to `Community 32`, `Community 38`, `Community 7`, `Community 42`, `Community 45`, `Community 50`, `Community 20`, `Community 26`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
